...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    ...
    'id'            => 'sidebar-primary',
    'before_widget' => '<section class="widget %1$s %2$s well"><div class="widget-inner">',
    'after_widget'  => '</div></section>',
    'before_title'  => '<h2 class="heading-shadow">',
    'after_title'   => '</h2>',
  ));

  register_sidebar(array(
    'name'          => __('Full Width Footer', 'roots'),
    'id'            => 'sidebar-footer',
    'before_widget' => '<section class="widget %1$s %2$s well"><div class="widget-inner">',
    'after_widget'  => '</div></section>',
    'before_title'  => '<h2>',
...
class Roots_Vcard_Widget extends WP_Widget {
  private $fields = array(
	...
	'org'              => 'Organization/Department (optional)',
	'extended_address' => 'Building/Suite (optional)',
  ...
  function __construct() {
    ...
    $this->WP_Widget('widget_roots_vcard', __('Contact Us', 'roots'), $widget_ops);
  ...
  ?>
    <p class="vcard">
      ...
      <span class="adr">      
		<span class="extended_address"><?php echo $instance['extended_address']; ?></span><br>
      ...
      <span class="tel"><span class="value"><?php echo $instance['tel']; ?></span>
      <span class="value"><?php echo $instance['fax']; ?></span></span><br>
